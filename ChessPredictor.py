...
#start a tensor flow interactive session
...
img_file = 'chess_example.png'
folder = "input_boards"
img = PIL.Image.open(f"{folder}/{img_file}")
...
def getChessLines(hdx, hdy, hdx_thresh, hdy_thresh):
    ...
    # Blur
    gausswin = scipy.signal.windows.gaussian(21,4., sym = True)
